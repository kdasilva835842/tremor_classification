...
data_path = "Dataset/RotOnly/Augmented_2_00_5"
out_path = "CloudOutput/Augmented_2_00_5"
...
for iteration_number, (train, test) in enumerate(kfold.split(data, labels)):
    ...
    # Setting up paths
    figPath = os.path.sep.join([out_path,"{}-{}.png".format(os.getpid(),iteration_number)])
    jsonPath = os.path.sep.join([out_path,"{}-{}.json".format(os.getpid(),iteration_number)])
    modelPath = os.path.sep.join([out_path, "model-{}-{}.h5".format(os.getpid(),iteration_number)])
    cmPath = os.path.sep.join([out_path, "CM_{}-{}.png".format(os.getpid(),iteration_number)])
